...
```javascript
iterLucasSeq = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-sequences-lucas@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-sequences-lucas@umd/bundle.js"></script>
```
